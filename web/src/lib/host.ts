...
export const FIXTURE_TICKETS: KitchenTicket[] = [
  ...
  { id: 'T-205', memberName: 'Jonas', bay: 1, items: ['Gudbrandsdalspølse', 'Cappuccino'], chargeCompleteMin: 13, prepMin: 5, status: 'queued' },
  { id: 'T-206', memberName: 'Lene', bay: 5, items: ['Rømmegraut'], chargeCompleteMin: 18, prepMin: 6, status: 'queued' },
]
